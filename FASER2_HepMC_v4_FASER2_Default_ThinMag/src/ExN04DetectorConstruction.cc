...
G4VPhysicalVolume* ExN04DetectorConstruction::Construct()
{
  ...
  */
  ...
  //------------------------------ Magnet 3
  G4VSolid* magcase_tubs3 = new G4Tubs("magcaseTubs_tubs3", fmag_rmax, fmagcase_rmax, fmag3_dz/2, fmag_sphi, fmag_dphi);
  G4LogicalVolume* magcase_log3 = new G4LogicalVolume(magcase_tubs3, fAir,"magcaseT_L3",0,0,0);
  //G4VPhysicalVolume * magcase_phys3 =
    new G4PVPlacement(0,G4ThreeVector(0,0,fmag3_locz+(fmag3_dz/2.)), magcase_log3, "magcase_phys3",experimentalHall_log, false, 0);
  G4VisAttributes* magcase_logVisAtt3 = new G4VisAttributes(G4Colour(1.0,1.0,0.0,0.1));
  //magcase_logVisAtt->SetForceWireframe(true);
  magcase_logVisAtt3->SetForceSolid(true);
  magcase_log3->SetVisAttributes(magcase_logVisAtt3);

  G4VSolid* mag_tubs3 = new G4Tubs("magTubs_tubs3", 0, fmag_rmax, fmag3_dz/2, fmag_sphi, fmag_dphi);
  G4LogicalVolume* mag_log3  = new G4LogicalVolume(mag_tubs3, fAir,"magT_L3",0,0,0);
  //G4VPhysicalVolume * mag_phys3 =
    new G4PVPlacement(0,G4ThreeVector(0,0,fmag3_locz+(fmag3_dz/2.)), mag_log3, "mag_phys3", experimentalHall_log, false, 0);
  G4VisAttributes* mag_logVisAtt3 = new G4VisAttributes(G4Colour(1.0,1.0,1.0,0.1));
  mag_logVisAtt3->SetForceWireframe(false);
  mag_logVisAtt3->SetForceSolid(true);
  mag_log3->SetVisAttributes(mag_logVisAtt3);


  ExN04Field* myField3 = new ExN04Field;
  myField3->fBx = 0*tesla;
  //myField3->fzmin=100*m;//fmag3_locz;
  //myField3->fzmax=100*m;//fmag3_locz+fmag3_dz;
  myField3->fzmin=fmag3_locz;
  myField3->fzmax=fmag3_locz+fmag3_dz;
  G4FieldManager* localFieldMgr3 = new G4FieldManager(myField3);
  localFieldMgr3->SetDetectorField(myField3);
  localFieldMgr3->CreateChordFinder(myField3);
  mag_log3->SetFieldManager(localFieldMgr3, true);
  ...
  G4VPhysicalVolume * SD_phys = new G4PVPlacement(0, G4ThreeVector(0,0,fmag3_locz), SD_log, "SD_phys", experimentalHall_log, false, 0);
